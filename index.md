...
As I forgot to upload the assembled PLC parts with base cover for the STM32F401RE. Here it is. Here is the link for the stl [file](https://github.com/junedacaya/L-wingSolarPanelInteractiveDisplay/blob/master/Electronics/NucleoBox_V1.1.stl)
...
Uploaded my base case for my Nucleo F401RE in Electronics folder
